...
web build:
 - http://mootools.net/core/d60eeac319d0b95b721dbce71553698b

packager build:
 - packager build Core/Element Core/Element.Style Core/Element.Dimensions
...
var powered = new Element('img', {
    'src': chrome.extension.getURL('powered.png'),
    'class': 'powered'
});

/* check to see if the home logo is shown */
var home_logo = $$('.hp_sw_logo')[0];
if (home_logo) {
    var pos = home_logo.getPosition();
    var t = pos.y + 40;
    var left = pos.x + 65;

    powered.setStyle('top', t);
    powered.setStyle('left', left);
}
